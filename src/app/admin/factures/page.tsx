...
export default function AdminFacturesPage() {
  ...
  async function handleDownloadChorusPDF(orderId: string, orderNumber: string) {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erreur lors du téléchargement Chorus Pro')
    } finally {
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Toutes les commandes facturées
        </p>
      </div>
                        ...
                        <div className="flex items-center justify-center gap-2 flex-wrap">
                          ...
                          {order.invoice_url && (
                            <a
                              ...
                              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-medium transition-colors"
                            >
