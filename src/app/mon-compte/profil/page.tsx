      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-card rounded-xl border border-border/60 shadow-sm p-5 sm:p-6 space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <input
              value={email}
              disabled
              className="flex h-9 w-full rounded-md border border-input bg-muted/30 px-3 py-1 text-sm shadow-sm text-muted-foreground cursor-not-allowed"
            />
        ...
        <div className="flex gap-3 pt-6">
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-primary text-primary-foreground text-sm font-medium shadow-sm hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving ? (
              <>
